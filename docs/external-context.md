...
The [GPPS interpretation guide](gpps-interpretation.md) traces the patient-experience measures from their source and validity rules to the profile comparisons and Evidence Map boundaries.
...
![Practice-level patient-experience measures by frozen national profile](../outputs/figures/patient_experience_by_profile.png)
